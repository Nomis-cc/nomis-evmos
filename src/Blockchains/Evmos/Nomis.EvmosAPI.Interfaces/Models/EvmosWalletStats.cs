...
namespace Nomis.EvmosAPI.Interfaces.Models
{
    ...
    /// Evmos wallet stats.
    /// </summary>
    public class EvmosWalletStats
        : IWalletStats<EvmosTransactionIntervalData>
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "evmos")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "evmos")]
        ...
        public IEnumerable<EvmosTransactionIntervalData>? TurnoverIntervals { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "evmos")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "evmos")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "evmos")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "evmos")]
