...
namespace Nomis.EvmosAPI.Calculators
{
        ...
        IStatCalculator<EvmosWalletStats, EvmosTransactionIntervalData>
    {
        ...
        private readonly IEnumerable<EvmosAPIAccountInternalTransaction> _internalTransactions;
        private readonly IEnumerable<EvmosAPIAccountCommonTokenEvent> _tokenList;
        private readonly IEnumerable<EvmosAPIAccountERC20TokenEvent> _ecr20TokenTransfers;
        ...
        public EvmosStatCalculator(
            ...
            IEnumerable<EvmosAPIAccountInternalTransaction> internalTransactions,
            IEnumerable<EvmosAPIAccountCommonTokenEvent> tokenList,
            IEnumerable<EvmosAPIAccountERC20TokenEvent> ecr20TokenTransfers)
        {
            _address = address;
            _balance = balance;
        ...
        public EvmosWalletStats GetStats()
        {
            ...
            var intervals = IStatCalculator<EvmosWalletStats, EvmosTransactionIntervalData>
            ...
            var turnoverIntervals = IStatCalculator<EvmosWalletStats, EvmosTransactionIntervalData>
            ...
            return new()
            {
                ...
                WalletAge = IStatCalculator<EvmosWalletStats, EvmosTransactionIntervalData>
                ...
                BalanceChangeInLastMonth = IStatCalculator<EvmosWalletStats, EvmosTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<EvmosWalletStats, EvmosTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
