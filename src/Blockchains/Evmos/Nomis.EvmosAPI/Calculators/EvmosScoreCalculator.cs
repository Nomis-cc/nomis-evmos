// ------------------------------------------------------------------------------------------------------
// <copyright file="EvmosScoreCalculator.cs" company="Nomis">
...
{
    /// <summary>
    /// Evmos wallet score calculator.
    /// </summary>
    internal static class EvmosScoreCalculator
    {
        ...
        public static double GetScore(this IWalletStats<EvmosTransactionIntervalData> stats)
        {
            if (stats.NoData)
            {
                return 0;
